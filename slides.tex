  ...
  \begin{frame}
    ...
    \begin{tikzpicture}[remember picture,
      ...
      \draw[arrow, shorten <=0] let \p1 = (src.south),
                \p2 = (obj.west)
            in (\p1) -- (\x1, \y2) node [below, font=\small, align=left, xshift=-4mm] {compliation adds\\instrumentation} -- (\p2);
...
\} \\
  ...
  \begin{frame}
    ...
    \begin{tikzpicture}[remember picture,
                        overlay,
                        shift={(current page.south west)}]
      \node at (\paperwidth / 3, \paperheight / 2) {\includegraphics[scale=0.1]{aec-badge-ecoop}};
      \node [inner sep=0, anchor=east] (github) at (\paperwidth * 2/ 3, \paperheight / 2) {\includegraphics[scale=0.15]{github-logo}};
      ...
      \node at (\paperwidth / 2, \paperheight / 8) {\small Thanks to Derek Rayside for helping improve presentation clarity};
      \node [above=of github.south east] {\Large \texttt{https://eyl.io/}};
    \end{tikzpicture}
