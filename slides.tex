...
\end{frame}
  ...
  \begin{frame}
    ...
    \begin{tikzpicture}[remember picture,
                        overlay,
                        shift={(current page.south west)}]
      \node [scale=4] at (\paperwidth * 2 / 8, \paperheight / 6) {😀};
      \node [scale=4] at (\paperwidth * 3 / 8, \paperheight / 6) {😀};
      \node [scale=4] at (\paperwidth * 4 / 8, \paperheight / 6) {😀};
      \node [scale=4] at (\paperwidth * 5 / 8, \paperheight / 6) {😀};
      \node [scale=4] at (\paperwidth * 6 / 8, \paperheight / 6) {😀};
    \end{tikzpicture}
