...
\} \&   \&   \&   \&   \&   \&   \&   \&   \&   \&   \&   \&   \&   \&   \&   \&   \&   \&   \&   \&   \&   \&   \&   \&   \&   \&   \\
  ...
  \&   \& r \& e \& t \& u \& r \& n \&   \& |[black!50]|t \& |[black!50]|h \& |[black!50]|i \& |[black!50]|s \& |[black!50]|- \& |[black!50]|> \& v \& a \& l \& u \& e \& ; \\
      ...
      \node [node distance=4mm, fill=yellow!50, below=of defn] {
Writes allowed, no observable difference, better performance
      };
    \end{tikzpicture}
  \end{frame}
...
Writes allowed by compiler without \texttt{mutable}
  ...
  \begin{frame}
    ...
    \Large
    We want to observe caching field writes in both cases
    \\(shallow vs. deep)
...
Write allowed by compiler, but observable difference
  ...
  \begin{frame}
    \frametitle{We Observe Writes Through \const{} References}
    \Large
    \begin{tikzpicture}[remember picture,
                        overlay,
                        shift={(current page.south west)}]
\draw[label distance=23mm] (\paperwidth / 3, \paperheight / 2) node[label=above left:\textbf{Writes}, label=below:\textit{Our observations (all writes)}]{} circle (25mm);
\draw (\paperwidth / 3, \paperheight / 2) node [align=center] {Deep\\Logical} circle (12.5mm);
\node at (\paperwidth / 3, \paperheight * 11 / 16) {Incorrect};
\draw[label distance=16mm, fill=black!35] (\paperwidth * 2 / 3, \paperheight / 2) node[label=above right:\textbf{No writes}, align=center]{Deep\\Bitwise} circle (25mm);
    \end{tikzpicture}
  \end{frame}
  ...
  \begin{frame}
    ...
    Our analysis assumes deep immutability
    \\(i.e. writes through fields)
  ...
  \begin{frame}
    ...
    \begin{tikzpicture}[remember picture,
      ...
      \draw[arrow, shorten <=0] let \p1 = (src.south),
                \p2 = (obj.west)
            in (\p1) -- (\x1, \y2) node [below, font=\normalsize, align=left, xshift=-4mm] {compliation adds\\instrumentation} -- (\p2);
      \draw[arrow, shorten <=0] let \p1 = (obj.south),
                \p2 = (exe.west)
            in (\p1) -- (\x1, \y2) node [below, font=\normalsize, align=left] {linking adds\\runtime library} -- (\p2);
      \draw[arrow, shorten <=0] let \p1 = (exe.south),
                \p2 = (report.west)
            in (\p1) -- (\x1, \y2) node [below, font=\normalsize, align=left, xshift=4mm] {executing reports\\writes-through-\const{}} -- (\p2);

      \node at (\paperwidth / 2, \paperheight / 8) {Our tool, \structure{ConstSanitizer}, actions shown on edges};
    \end{tikzpicture}
  \end{frame}
...
\& \& \# \& 1 \& \& i \& n \& \& m \& a \& i \& n \\
  ...
  \begin{frame}
    ...
    \Large
    \begin{tabular}{b{4cm} b{5.2cm} b{3.3cm}}
...
\} \& ; \&   \&   \&   \&   \&   \&   \&   \&   \&   \&   \&   \&   \&   \&   \&   \&   \&   \&   \&   \&   \&   \&   \&   \&   \&   \&   \&   \&   \&   \&   \&   \&   \&   \&   \&   \&   \&   \&   \&   \&   \&   \&   \&   \&   \\
  ...
  \begin{frame}
    ...
    \begin{tikzpicture}
      ...
      \matrix (wgetopt) {
|[black!50]|. \& |[black!50]|. \& |[black!50]|. \&   \& \_ \& w \& g \& e \& t \& o \& p \& t \& \_ \& i \& n \& t \& e \& r \& n \& a \& l \& ( \& w \& c \& h \& a \& r \& \_ \& t \&   \& * \& |[blue]|c \& |[blue]|o \& |[blue]|n \& |[blue]|s \& |[blue]|t \&   \& * \& a \& r \& g \& v \& , \&   \& |[black!50]|. \& |[black!50]|. \& |[black!50]|. \& ) \&   \& \{ \\
...
|[black!50]|. \& |[black!50]|. \& |[black!50]|. \&   \& e \& x \& c \& h \& a \& n \& g \& e \& ( \& w \& c \& h \& a \& r \& \_ \& t \&   \& * \& * \& a \& r \& g \& v \& ) \&   \& \{ \\
  ...
  \begin{frame}
    ...
    \begin{tikzpicture}
      \matrix  {
v \& o \& i \& d \&   \& E \& m \& u \& l \& a \& t \& o \& r \& : \& : \& p \& r \& i \& n \& t \& ( \& |[blue]|c \& |[blue]|o \& |[blue]|n \& |[blue]|s \& |[blue]|t \&   \& P \& a \& r \& s \& e \& r \& : \& : \& P \& r \& i \& n \& t \&   \& * \& a \& c \& t \& ) \&   \& \{ \\
  ...
  \begin{frame}
    ...
    \begin{enumerate}
      ...
      \item Around half of writes-through-\const{} not logically immutable
            ...
            \vspace{1.5em}
            They appear to be undesirable and fixed by developers
    \end{enumerate}
  \end{frame}
