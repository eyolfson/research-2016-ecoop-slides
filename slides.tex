...
\frametitle{1}
    \begin{tikzpicture}[remember picture,
                        overlay,
                        shift={(current page.south west)}]
      \node [scale=3, anchor=base, draw, rounded corners] at (current page.center) {Immutability};

      \node [scale=4] (p1) at (\paperwidth * 2 / 8, \paperheight / 6) {😀};
      \node [scale=4] (p2) at (\paperwidth * 3 / 8, \paperheight / 6) {😀};
      \node [scale=4] (p3) at (\paperwidth * 4 / 8, \paperheight / 6) {😀};
      \node [scale=4] (p4) at (\paperwidth * 5 / 8, \paperheight / 6) {😀};
      \node [scale=4] (p5) at (\paperwidth * 6 / 8, \paperheight / 6) {😀};
    \end{tikzpicture}
  \end{frame}
...
\frametitle{2}
    \begin{tikzpicture}[remember picture,
                        overlay,
                        shift={(current page.south west)}]
      \node [scale=3, anchor=base, draw, rounded corners] at (\paperwidth / 4, \paperheight / 2) {Shallow};

      \node [scale=3, anchor=base, draw, rounded corners] at (\paperwidth *3 / 4, \paperheight / 2) {Deep};

      \node [scale=4] (p1) at (\paperwidth * 0.109375, \paperheight / 6) {😀};
      \node [scale=4] (p2) at (\paperwidth * 0.234375, \paperheight / 6) {😀};
      \node [scale=4] (p3) at (\paperwidth * 4 / 8, \paperheight / 6) {😶};
      \node [scale=4] (p4) at (\paperwidth * 6 / 8, \paperheight / 6) {😞};
      \node [scale=4] (p5) at (\paperwidth * 7 / 8, \paperheight / 6) {😞};
    \end{tikzpicture}
  \end{frame}
...
\frametitle{4}
  ...
  \begin{frame}
    ...
    \Large
    Bitwise: no writes to object
 
    \vspace{1em}
    Logically: no observable changes to object
  \end{frame}
...
[blue]|o \& |[blue]|n \& |[blue]|s \& |[blue]|t \& \& \{ \\
  ...
  \&   \&   \&   \& |[black!50]|t \& |[black!50]|h \& |[black!50]|i \& |[black!50]|s \& |[black!50]|- \& |[black!50]|> \& v \& a \& l \& i \& d \&   \& = \&   \& |[black!50]|. \& |[black!50]|. \& |[black!50]|. \& ; \\
